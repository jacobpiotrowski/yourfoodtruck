        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[hsl(142,70%,41%)] text-primary-foreground font-display font-semibold px-10 py-5 rounded-lg text-lg hover:opacity-90 transition-opacity"
            >
