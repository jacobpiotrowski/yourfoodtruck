  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <iframe
          src="https://www.youtube-nocookie.com/embed/i-mpPrmTcJI?autoplay=1&mute=1&loop=1&playlist=i-mpPrmTcJI&controls=0&showinfo=0&modestbranding=1&rel=0&playsinline=1&disablekb=1"
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[hsl(142,70%,41%)] text-primary-foreground font-display font-semibold px-8 py-4 rounded-lg text-lg hover:opacity-90 transition-opacity"
          >
